...
{
    [Serializable]
    public class UnityBoatPosRotMsg : Message
    {
        public const string k_RosMessageName = "unity_sailor_msgs/UnityBoatPosRot";
        ...
        public UnityBoatPosRotMsg(float pos_x, float pos_y, float pos_z, float rot_x, float rot_y, float rot_z, float rot_w)
        {
            this.pos_x = pos_x;
            this.pos_y = pos_y;
            this.pos_z = pos_z;
        ...
        public static UnityBoatPosRotMsg Deserialize(MessageDeserializer deserializer) => new UnityBoatPosRotMsg(deserializer);

        private UnityBoatPosRotMsg(MessageDeserializer deserializer)
        {
